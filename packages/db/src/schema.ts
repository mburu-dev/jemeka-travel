...
export const destinations = sqliteTable("destinations", {
  ...
  experienceCategories: text("experience_categories", { mode: "json" }).$type<string[]>(),
  wildlife: text("wildlife", { mode: "json" }).$type<string[]>(),
  durationRecommendations: text("duration_recommendations"),
  videoExperienceUrl: text("video_experience_url"),
  destinationTestimonials: text("destination_testimonials", { mode: "json" }).$type<{ quote: string; author: string; rating: number }[]>(),
