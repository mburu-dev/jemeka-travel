...
export default function Home() {
  ...
  const { data: featuredDestinations, isLoading: isLoadingDestinations } = trpc.destination.featured.useQuery();
  const { data: featuredPackages, isLoading: isLoadingPackages } = trpc.package.featured.useQuery();
    ...
    <Layout>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {isLoadingDestinations ? (
              <div className="col-span-3 text-center py-12 text-gray-500 animate-pulse">Loading amazing destinations...</div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {isLoadingPackages ? (
              <div className="col-span-3 text-center py-12 text-gray-500 animate-pulse">Loading amazing packages...</div>
            ) : packages.length === 0 ? (
      ...
      <section className="relative py-32 overflow-hidden">
        <div className="absolute inset-0">
          <img src="/hero-home.jpg" alt="Start your journey" className="w-full h-full object-cover" />
