...
export default function DestinationDetail() {
  ...
  const { data: destination, isLoading } = trpc.destination.getBySlug.useQuery(
    { slug: slug! },
    { enabled: !!slug }
  );
            ...
            <div className="space-y-6">
              ...
              <Card className="border-0 shadow-lg">
                <CardContent className="p-6 space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    <MapPin className="w-5 h-5 text-[#2A9D8F] mt-0.5" />
                    <div>
                      <div className="text-sm font-medium text-gray-700">
                        Location
                      </div>
                  ...
                  {destination.activities && (
                    <div className="flex items-start gap-3">
                      <ThermometerSun className="w-5 h-5 text-[#2A9D8F] mt-0.5" />
                      <div>
                        <div className="text-sm font-medium text-gray-700">
                          Activities
                        </div>
                        <div className="text-sm text-gray-500">
                          {(destination.activities as string[]).length} types
                          available
                        </div>
                      </div>
                    </div>
                  ...
                  <Link href="/packages">
                    <Button className="w-full bg-[#0F4C75] hover:bg-[#0a3a5a] mt-2">
                      View All Packages
              ...
              {/* CTA Card */}
              <Card className="border-0 shadow-lg bg-gradient-to-br from-[#0F4C75] to-[#264653]">
                <CardContent className="p-6 text-white text-center">
                  ...
                  <Link href="/contact">
                    <Button className="w-full bg-[#F4A261] hover:bg-[#e08c4f] text-white">
                      Get in Touch
                    </Button>
                  </Link>
                </CardContent>
